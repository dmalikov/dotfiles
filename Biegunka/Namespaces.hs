...
namespace_mpd = namespace "mpd" $
  dotfiles $ do
    ...
    decrypt "configs/mpd/scrobblers/Main.hs" "configs/mpd/scrobblers/.Main.hs.e" ".mpd/scrobblers/Main.hs"
...
namespace_transmission = namespace "transmission" $
  dotfiles $
    decrypt "configs/transmission/transmission.proxy.rc" "configs/transmission/.transmission.proxy.rc.e" ".transmission.proxy.rc"

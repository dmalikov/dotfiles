...
, optparseApplicative_0_11_0_1, pointed, reflection, safecopy, semigroups
...
cabal.mkDerivation (self: {
  ...
  buildDepends = [
    ...
    meep mtl optparseApplicative_0_11_0_1 pointed reflection safecopy semigroups
    stm tagged taggedTransformer terminalSize text transformers void
  ];
  testDepends = [
    dataDefaultClass directoryLayout filepath free hspec
    hspecExpectationsLens lens optparseApplicative_0_11_0_1 semigroups temporary
    text transformers
  ];
  meta = {
